...
// using Veriflow.Avalonia.Helpers;
...
namespace Veriflow.Avalonia.ViewModels
{
    public partial class OffloadViewModel : ObservableObject
    {
        ...
        {
            // STUBBED: Requires StorageProvider from Window/TopLevel
            return null;
        }
        ...
        private void RefreshDrives()
        {
            ...
            if (Dispatcher.UIThread.CheckAccess()) UpdateDrivesCollection(safeDriveList);
            else Dispatcher.UIThread.Invoke(() => UpdateDrivesCollection(safeDriveList));
        }
